...
Rectangle {
    ...
    {
        title.setText(langStrObject.GetLangString("ETCS_NETWORK"));
        ...
        sourceRefresh.setText(langStrObject.GetLangString("ETCS_SOURCE_REFRESH"));
        confirmBtn.setTextInfo(langStrObject.GetLangString("ETCS_OK"));
    }
    ...
    function initStatus()
    {
        ...
        zeroPrelistenId();
        sources.clearText();
        sourcesDelBtn.setVisibleValue(false);
        iomapListModel.clearListModel();
        sourceManageObject.clearFragment();
        sourceManageObject.clearNetworkSourceList();
        sourceManageObject.getNetworkSourceList(getPath());
    ...
    function quitStatus()
    {
        ...
        setNode(0);
        refreshMask.setVisibleValue(false);
    ...
    function preListenBtnClickSlot(status)
    {
        if (status === true)
        {
            ...
            var errorCode = pageObject.networkPageStartCall("PreListen",getNode(),
    ...
    function callBtnClickSlot(status)
    {
        if (status === true)
        {
            ...
            var errorCode = pageObject.networkPageStartCall("Call", getNode(),
                                                    callSettingPage.getgPrority(),
                                                    volumeSlider.getValue(),
                                                    callSettingPage.getgPreSignal(),
                                                    callSettingPage.getgReconnect(),
    ...
    function audioDatabaseChangedSlot(node, path)
    {
        if (getNode() === node)
        {
            setPath(path);
            refreshMask.setVisibleValue(true);
        }
    }
    ...
    Rectangle{
        ...
        CommonText{
            ...
            text: langStrObject.GetLangString("ETCS_NETWORK")
    ...
    ImageButton{
        ...
        visible: sourceManageObject.getFragmentSize() === 0 ? false : true
        onClickedSignal: {
            sources.clearText();
            sourceManageObject.clearFragment();
            setVisibleValue(false);
    ...
    ListModel {
        ...
        {
            var count = sourceManageObject.getGroupCount();
    ...
    DelegateModel {
        ...
        delegate:Rectangle{
                    ...
                    ToggleButton3{
                        ...
                        anchors.horizontalCenter: parent.horizontalCenter
                        dataText: sourceManageObject.getGroupName(nIndex) === "Record" ? langStrObject.GetLangString("ETCS_RECORD") : sourceManageObject.getGroupName(nIndex)
                        ...
                        onSelectSignal: {
                            ...
                            groupIndex = nIndex;
                            iomapListModel.clearListModel();
                            iomapListModel.createListModel(nIndex);
                        }
                        Component.onCompleted: {
                            if (nodeVisualModel.selectedItems.count > 0)
                            {
    ...
    ListModel {
        ...
        {
            var count = sourceManageObject.getIOMapCount(index);
    ...
    DelegateModel {
        ...
        delegate:Rectangle{
                ...
                TextButon{
                    ...
                    anchors.bottom: parent.bottom
                    anchors.horizontalCenter: parent.horizontalCenter
                    info: sourceManageObject.getGroupValue(groupIndex, nIndex, "Desc")
                    textColor: "#303030"
                    border.color: "#c0c0c0"
                    ...
                    onClickedSignal: {
                        ...
                        if (sourceManageObject.isOverNetworkSourceMaxCount() === true)
                        {
                        ...
                        sourceManageObject.addFragment(groupIndex, nIndex);
                        sourcesDelBtn.setVisibleValue(true);
                    }
                }
        }
    }
    ...
    MoreFuncView{
        ...
        onSendPredefineBtnSingal: {
            ...
            predefineSetting.addInitStatus(langStrObject.GetLangString("ETCS_NETWORK"))
        }
    ...
    PredefineSetting{
        ...
        onSaveSignal: {
            ...
            pageObject.networkMakePredefine(getNode(),
    ...
    ScheduleSettingView{
        ...
        onSaveSignal: {
            ...
            pageObject.networkMakeSchedule(getNode(),
                                        callSettingPage.getgPrority(),
                                        volumeSlider.getValue(),
                                        callSettingPage.getgPreSignal(),
                                        callSettingPage.getgReconnect(),
    ...
    Rectangle{
        ...
        Rectangle{
            ...
            CommonText{
                ...
                wrapMode: Text.Wrap
                maximumLineCount: 2
                text: langStrObject.GetLangString("ETCS_SOURCE_REFRESH")
            }
    ...
    Component.onCompleted: {
        ...
        logicObject.audioDatabaseChangedSignal.connect(audioDatabaseChangedSlot);
