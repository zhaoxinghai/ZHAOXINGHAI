...
bool CThreadDevice::OccupyPort(int nPort)
{
    ...
    if (iter != m_mapPortLeft.end())
    {
        ...
        if(iter->second)
        {
            printf("%s","CThreadDevice::OccupyPort Left Error");
        }
        iter->second = true; 
    }
    else
    {
        ...
        if (iter != m_mapPortRight.end())
        {
            ...
            if(iter->second)
            {
                printf("%s","CThreadDevice::OccupyPort Right Error");
            }
            iter->second = true;
        }
    }
...
void CThreadDevice::FreePort(int nPort)
{
    ...
    if (iter != m_mapPortLeft.end())
    {
        if(!iter->second)
        {
            printf("%s","CThreadDevice::FreePort Left Error");
        }
        iter->second = false;
    }
    else
    {
        ...
        if (iter != m_mapPortRight.end())
        {
            if(!iter->second)
            {
                printf("%s","CThreadDevice::FreePort Right Error");
            }
            iter->second = false;
        }
    }
